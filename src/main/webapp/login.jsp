...
<%
    ...
    new Driver();
    Connection connection = DriverManager.getConnection("jdbc:mysql:///?user=root&password=liweixi");
    ...
    if (resultSet.next()) {
        ...
        request.gatRequestDispatcher("home.jsp").forward(request, response); // 可以保存
    } else {
        // failed
